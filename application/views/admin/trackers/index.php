...
MIN(timestamp) as start_time, MAX(timestamp) as end_time FROM trackers GROUP BY visitor_id";
...
trackers WHERE visitor_id = '$visitor_id'";
        $result = mysql_query($sql);
    }
}
...
<?php
        do {
            ...
            echo "<td><a href='?view=record&id={$row["visitor_id"]}'>view</a></td>";
            echo "</tr>";
