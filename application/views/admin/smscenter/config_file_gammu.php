        ...
        <div class="span5">
            <form action="" method="post" class="form-horizontal">
                <div class="control-group">
                    <label class="control-label">ID Modem</label>
                    <div class="controls">
                        <input type="text" name="id_modem">
                    </div>
                </div>        
                <div class="control-group">
                ...
                <div class="control-group">
                    <label class="control-label">Receive Message</label>
                    <div class="controls">                
                        <select name="receive" disabled>
                            <option value="yes">yes</option>
                            <option value="no">no</option>
                        </select>
                    </div>
...
// jumlah maksimum modem yg bisa diset
    ...
    <?php
    if ($sum == 0)
        echo "<p>Phone/Modem belum ada</p>";
    else {
