...
--
-- Host: localhost
-- Generation Time: May 16, 2013 at 10:27 PM
...
(2, 'Kantor Cabang Operasional', '(022) 589 1332', '<p>Jl. Raya Soreang No. 26 Soreang LT1</p>', '', '', 0),
...
(2, 'Kunjungan BPR Kalimantan', 'kunjungan-bpr-kalimantan', '<p>Kunjungan BPR Kalimantan</p>', '', '0000-00-00', 0, '2013-05-14 20:16:31', '2013-05-16 20:23:08'),
(3, 'Burung Hantu Asal Kalimantan 2', 'burung-hantu-asal-kalimantan-2', 'Burung Hantu Asal Kalimantan ini bisa hidup tanpa makan selaman seminggu', 'lr1_large.png', '0000-00-00', 2, '2013-05-16 20:30:53', '2013-05-16 20:35:50'),
(4, 'Perkembangna HTML', 'perkembangna-html', 'Perkembangna HTML', 'html5.jpg', '0000-00-00', 2, '2013-05-16 20:47:11', '0000-00-00 00:00:00'),
(5, 'Hajatan BPR Banjaran yang ke 2 kalinya', 'hajatan-bpr-banjaran-yang-ke-2-kalinya', 'Hajatan BPR Banjaran yang ke 2 kalinya', 'dawn_of_ubuntu.png', '0000-00-00', 2, '2013-05-16 20:49:12', '0000-00-00 00:00:00');
...
CREATE TABLE IF NOT EXISTS `highcharts` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `year` int(4) NOT NULL,
  `savings` decimal(12,0) NOT NULL,
  `credits` decimal(12,0) NOT NULL,
  `depositos` decimal(12,0) NOT NULL,
  `profits` decimal(12,0) NOT NULL,
  PRIMARY KEY (`id`)
